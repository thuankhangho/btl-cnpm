    ...
    <div class="row">
      ...
      <div class="daily-task col-6">
        <table class="table table-hover">
            ...
            <tbody>
                <tr>
                <th style="width: 10%; background: green; color: white">07:00</th> <td style="background: #E4F8EB">Daily standup</td>
                </tr>
                <tr>
                <th style="width: 10%; background: green; color: white">09:00</th> <td style="background: #E4F8EB">Assign routes to today's employees</td>
                </tr>
                <tr>
                <th style="width: 10%; background: green; color: white">10:00</th> <td style="background: #E4F8EB">Random MCPs check</td>
                </tr>
                <tr>
                <th style="width: 10%; background: green; color: white">12:00</th> <td style="background: #E4F8EB">Lunch</td>
                </tr>
                <tr>
                <th style="width: 10%; background: green; color: white">13:00</th> <td style="background: #E4F8EB">Meetup with government</td>
                </tr>
                <tr>
                <th style="width: 10%; background: green; color: white">15:00</th> <td style="background: #E4F8EB">Daily radio show (Asking While Snacking)</td>
                </tr>
                <tr>
                <th style="width: 10%; background: green; color: white">17:00</th> <td style="background: #E4F8EB">Finish work</td>
                </tr>
            </tbody>
        </table>
        </div>
